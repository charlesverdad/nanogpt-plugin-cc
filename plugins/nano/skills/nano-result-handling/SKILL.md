...
- If the footer shows `denied=...`, tell the user which tool/command was denied and offer to rerun with `--allow-bash "<prefix>"` rather than working around it yourself.
